...
from functions import misc, plot, mitigation_strategies
...
class Attacker:
    ...
    def get_fake_gps(self, obj: mitigation_strategies.DroneWithRangeMitigation):
        ...
        return obj.ekf.x[0:2] + misc.random_gaussian(obj.gps_cov) + self.attack_vectors[index]

    # Commented to remove dependency on cvxpy:
