...
if __name__ == "__main__":
    ...
    # Stationary drones:
    G.add_vertex(name=name_list[2],
                 object=sensor.Drone2D(position=(-8, 0),
                                       trajectory=misc.fixed_point_trajectory(point=(-8, 0)),
                                       perfect_init_conditions=True))
    G.add_vertex(name=name_list[3],
                 object=sensor.Drone2D(position=(8, 0),
                                       trajectory=misc.fixed_point_trajectory(point=(8, 0)),
                                       perfect_init_conditions=True))
    G.add_vertex(name=name_list[4],
                 object=sensor.Drone2D(position=(0, -8),
